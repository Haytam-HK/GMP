...
export default {
  ...
  let id = this.$route.params.id;
   axios.get(URL.URL+'journales_list/'+id)
   ...
   updateItem() {
  let id = this.$route.params.id; 
        axios.put( this.URL.URL+'journales_list/'+id, this.item);
           this.getItem();      

          this.success =true;
          this.eror=false;
          this.num = this.item.nome_journale;
    }
  }
};
</script>
...
<div   id="body-pd"  > 
   <SideBare />
   <h2 class="form-label" for="datatable-search-input">Modifier le Journal</h2>	 
<center>   
...
<div class="col"> 
<button   class="btn btn-light">Modifier le Journal</button> 
